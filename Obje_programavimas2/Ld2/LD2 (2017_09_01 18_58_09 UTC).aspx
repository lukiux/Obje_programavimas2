<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LD2.aspx.cs" Inherits="LD2" %>
...
<body>
    ...
    <div> 
        ...
        <asp:Button ID="Button1" runat="server"  Style="top: 20%; left: 40%;" Text="Spausdinti" OnClick="Button1_Click" CssClass="newButton1"/>
        ...
        <asp:Button ID="Button2" runat="server" Style="top: 95%; left: 40%; position:absolute;" Text="OK" CssClass="newButton1" OnClick="Button2_Click"/>
